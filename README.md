...
- [hook_normalize_job_mpiomp](hook_normalize_job_mpiomp.md) — normalises and validates CPU/MPI/OpenMP `select` chunks, applies CPU defaults, and enforces a consistent job-wide SMT request before scheduling.
